...
const (
	...
	AuditServiceName = "oblivio.v1.AuditService"
)
...
const (
	...
	AuditServiceListAuditProcedure = "/oblivio.v1.AuditService/ListAudit"
)

// AuditServiceClient is a client for the oblivio.v1.AuditService service.
type AuditServiceClient interface {
	ListAudit(context.Context, *connect.Request[v1.ListAuditRequest]) (*connect.Response[v1.ListAuditResponse], error)
}

// NewAuditServiceClient constructs a client for the oblivio.v1.AuditService service. By default, it
...
func NewAuditServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AuditServiceClient {
	...
	auditServiceMethods := v1.File_oblivio_v1_audit_proto.Services().ByName("AuditService").Methods()
...
// ListAudit calls oblivio.v1.AuditService.ListAudit.
...
// AuditServiceHandler is an implementation of the oblivio.v1.AuditService service.
...
func NewAuditServiceHandler(svc AuditServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/oblivio.v1.AuditService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAuditServiceHandler) ListAudit(context.Context, *connect.Request[v1.ListAuditRequest]) (*connect.Response[v1.ListAuditResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("oblivio.v1.AuditService.ListAudit is not implemented"))
}
